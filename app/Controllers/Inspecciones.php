...
class Inspecciones extends BaseController
{
    ...
    public function exportar_inspeccion_db(){
        ...
        // shell_exec('mysqldump -P 3306 -h srv1064.hstgr.io -u u695808356_root --password="Test#2023" u695808356_etic_system_db causa_principal clientes datos_reporte equipos estatus_color_text estatus_inspeccion estatus_inspeccion_det fabricantes fallas fases grupos grupos_sitios historial_problemas inspecciones inspecciones_det linea_base problemas severidades sitios tipo_ambientes tipo_fallas tipo_inspecciones tipo_prioridades ubicaciones usuarios --where="Id_Inspeccion='.$id_inspeccion.' OR Id_Inspeccion='."'flag_export'".' OR Id_Inspeccion IS NULL OR Id_Sitio= '.$id_sitio.' OR Id_Sitio='."'flag_export'".'" >'.$ruta_guardar_script);
        shell_exec('mysqldump -P 3306 -h srv1064.hstgr.io -u u695808356_root --password="Test#2023" u695808356_etic_system_db causa_principal clientes datos_reporte equipos estatus_color_text estatus_inspeccion estatus_inspeccion_det fabricantes fallas fases grupos grupos_sitios historial_problemas inspecciones inspecciones_det linea_base problemas severidades sitios tipo_ambientes tipo_fallas tipo_inspecciones tipo_prioridades ubicaciones usuarios --where="Id_Sitio='.$id_sitio.' OR Id_Sitio='."'flag_export'".' OR Id_Sitio IS NULL " >'.$ruta_guardar_script);
    ...
    public function generarReporteListaProblemasExcel($id_inspeccion,$fecha_inicio, $fecha_fin){
        $inspeccionesMdl = new InspeccionesMdl();
        ...
        $datosInspeccion = $inspeccionesMdl->obtenerRegistros($id_inspeccion);
        // CONSULTA DEL SITIO
        $datosSitio = $sitiosMdl->obtenerRegistros($datosInspeccion[0]["Id_Sitio"]);
        ...
        $condicion = [
            'Id_Sitio' => $datosInspeccion[0]["Id_Sitio"],
        ...
        $writer->save($_SERVER["DOCUMENT_ROOT"].'/public/Archivos_ETIC/inspecciones/'.$nombreExcel);
        
        return $this->response->download($_SERVER["DOCUMENT_ROOT"].'/public/Archivos_ETIC/inspecciones/'.$nombreExcel, null);
    }
}